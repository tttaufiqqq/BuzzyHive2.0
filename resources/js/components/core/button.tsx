  ...
  ({ className, variant = 'primary', size = 'md', ...props }, ref) => {
    ...
    return (
      <button
        ref={ref}
        className={cn(
          'inline-flex items-center justify-center rounded-full transition-all active:scale-95 disabled:opacity-50 disabled:pointer-events-none font-medium cursor-pointer',
          variants[variant],
          sizes[size],
          className
        )}
